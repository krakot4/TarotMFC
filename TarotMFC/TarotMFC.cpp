...
// TarotMFC.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CTarotMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CTarotMFCApp

CTarotMFCApp::CTarotMFCApp()
{
...
// Seul et unique objet CTarotMFCApp

CTarotMFCApp theApp;


// initialisation de CTarotMFCApp

BOOL CTarotMFCApp::InitInstance()
{
	...
	CNom dlg;					//PREMIERE PAGE//PAGE PRINCIPALE	
	m_pMainWnd = &dlg;
